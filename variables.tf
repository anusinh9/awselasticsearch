...
#Unless zone count is 3 we cannot achieve cluster node configuration of 3 nodes
...
# Encryption setting for data AWS free tier doesn't support encyrption for data at rest
